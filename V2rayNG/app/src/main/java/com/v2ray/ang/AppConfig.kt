...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/tristesky/Lumina"
    const val APP_API_URL = "https://api.github.com/repos/tristesky/Lumina/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/tristesky/Lumina/master/CR.md"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly9lbi5oaWZ1OC5jb20="
